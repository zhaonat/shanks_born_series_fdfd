function [A, b, omega, ex_op, ey_op,Dxf, Dyf,Dxb, Dyb, Tepx, Tepy ] = ...
...
%% construct operators for H field reconstruction
ex_op = 1/(1i*omega)*Tepy^-1*(Dyb_pml);
ey_op = 1/(1i*omega)*Tepx^-1*(-Dxb_pml);
